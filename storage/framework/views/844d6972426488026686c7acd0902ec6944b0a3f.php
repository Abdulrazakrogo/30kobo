            ...
            <div class="row my-4">
                ...
                <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="pull-right card-title">GDP: <?php echo e((round($island_gdp_live,2))); ?></h5>
            ...
            <div class="row my-4">
                ...
                <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="pull-right card-title">GDP: <?php echo e((round($kano_gdp_live,2))); ?></h5>
                ...
                <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="pull-right card-title">GDP: <?php echo e((round($abuja_gdp_live,2))); ?></h5>
                  ...
                  <table class="table">
                      ...
                      <tbody>
                        ...
                        <?php $__currentLoopData = $updates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $update): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($update->updated_at); ?></td>
                                <td><?php echo e($update->island_usd); ?></td>
                                <td><?php echo e($update->airport_usd); ?></td>
                                <td><?php echo e($update->island_usd); ?></td>
                                <td><?php echo e($update->victoria_usd); ?></td>
                                <td><?php echo e($update->kano_usd); ?></td>
                                <td><?php echo e($update->abuja_usd); ?></td>
                                <td>
                            </tr>
